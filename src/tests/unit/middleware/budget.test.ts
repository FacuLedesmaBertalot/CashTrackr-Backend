...
import { hasAccess, validateBudgetExists } from '../../../middleware/budget.js';
import Budget from '../../../models/Budget.js';
import { budgets } from '../../mocks/budgets.js';
...
describe('Budget Middleware - hasAccess', () => {
    ...
    it('should call return 401 error if userId does not have access to budget', () => {
        const req = createRequest({
            budget: budgets[0],
            user: { id: 2 }
        })
